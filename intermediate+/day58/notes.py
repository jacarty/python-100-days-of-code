...
#         <div class="col-12 col-sm-8 col-lg-6"> <img src="images/iphone.png" height="500" class="d-block mx-lg-auto align-items-end"
#             alt="Bootstrap Themes" loading="lazy"> </div>
#         <div class="col-lg-4">
#           <h1 class="display-6 fw-bold text-body-emphasis lh-1 mb-3">Meet new and interesting dogs nearby. Woof!</h1>
...
#         <h2 class="text-body-emphasis mb-4">"I no longer have to sniff other dogs for love. I've found the hottest Corgi on TinDog. Woof."</h2>
#         <img src="images/dog-img.jpg" height="200" class="rounded-circle mx-lg-auto py-4" alt="Labrador"loading="lazy">
#         <p class="col-lg-8 mx-auto text-muted">Pebbles, New York </p>
#         <img src="images/techcrunch.png" height="50" class="mx-lg-auto mt-4 py-2 px-5" alt="techcrunch" loading="lazy">
#         <img src="images/mashable.png" height="50" class="mx-lg-auto mt-4 py-2 px-5" alt="techcrunch" loading="lazy">
#         <img src="images/bizinsider.png" height="50" class="mx-lg-auto mt-4 py-2 px-5" alt="techcrunch" loading="lazy">
#         <img src="images/tnw.png" height="50" class="mx-lg-auto mt-4 py-2 px-5" alt="techcrunch" loading="lazy">
#       </div>
#     </div>
#   </section>
...
#               <div class="card-header py-3 card-header py-3 text-bg-dark border-dark">
...
#             <small class="d-block mb-3 text-body-secondary">© TinDog 2025</small>
#           </div>
#           <div class="col-4 col-md">
#             <h5>Features</h5>
#             <ul class="list-unstyled text-small">
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Cool stuff</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Random feature</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Team feature</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Stuff for developers</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Another one</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Last time</a></li>
#             </ul>
#           </div>
#           <div class="col-4 col-md">
#             <h5>Resources</h5>
#             <ul class="list-unstyled text-small">
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Resource</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Resource name</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Another resource</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Final resource</a></li>
#             </ul>
#           </div>
#           <div class="col-4 col-md">
#             <h5>About</h5>
#             <ul class="list-unstyled text-small">
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Team</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Locations</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Privacy</a></li>
#               <li class="mb-1"><a class="text-white text-decoration-none" href="#">Terms</a></li>
#             </ul>
#           </div>
#         </div>
#       </footer>
